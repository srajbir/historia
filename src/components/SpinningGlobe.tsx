...
export default function SpinningGlobe() {
  ...
  useEffect(() => {
    ...
    polygonSeries.mapPolygons.template.setAll({
      ...
      stroke: am5.color(darkMode ? '#2d4f17' : '#2d4f17'),
    });
  ...
  return (
    <section className="rounded w-full flex justify-center items-center shadow bg-white/70 dark:bg-[#1f1f1f99] lg:p-6 p-2 my-6 flex-col-reverse md:flex-row gap-2">
